...
const validateFileContent = (content) => {
  ...
  return {
    ...
    isValid: invalidPhones.length === 0 && validPhones.length > 0 // 全部符合格式且至少有一个手机号
  }
}
  ...
  >
    ...
    <template #footer>
      <div class="dialog-footer">
        ...
        <el-button type="primary" @click="handleNext" class="next-btn" :loading="uploading" :disabled="uploading && uploadProgress >= 100">
