        ...
        <el-badge is-dot>
          <el-tooltip content="通知" placement="bottom">
            <i class="el-icon-bell">
              <svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="20" height="20">
                <path d="M816 768h-24V428c0-141.1-104.3-257.8-240-277.2V112c0-22.1-17.9-40-40-40s-40 17.9-40 40v38.8C336.3 170.2 232 286.9 232 428v340h-24c-17.7 0-32 14.3-32 32v32c0 4.4 3.6 8 8 8h656c4.4 0 8-3.6 8-8v-32c0-17.7-14.3-32-32-32zM512 844c38.5 0 70-31.5 70-70h-140c0 38.5 31.5 70 70 70z" fill="currentColor"></path>
              </svg>
            </i>
          </el-tooltip>
        </el-badge>
